...
int main(){
	//structure
	struct demo d1;	//create structure object
	d1.x = 5;
	d1.y = 10.5;
	printf("\nstructure x and y : %d  %.2f", d1.x, d1.y);	//display structure value
	
	//union
	un1.num = 5;
	un1.num1 = 10.4;
	//printf("\nnumber x and y : %d %.2f", un1.num, un1.num1);
	printf("\nno of intiger : %d",un1.num);	//display value
	printf("\nno of float : %.2f",un1.num1);	//display value
	return 0;
}
