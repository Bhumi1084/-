...
#display  a range of products whose price is in the range Rs.200 to Rs.600. Begin and end values are included. 
...
#display and calculate the average price for a manufacturer code of 16. Return avg.
select AVG(PRO_PRICE) as avg_price
from item_mast where PRO_COM = 16;

#display the pro_name as 'Item Name' and pro_priceas 'Price in Rs.'
select PRO_NAME as 'Item Name', PRO_PRICE as 'Price in Rs' from item_mast;

#e items whose prices are higher than or equal to $250. Order the result by product price in descending, 
